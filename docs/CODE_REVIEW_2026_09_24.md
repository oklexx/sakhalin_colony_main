...
- [x] **P3-3**: job `lint` в CI — `ruff check --select F821,F811,F841,F401,E722,B905,E9,F63,F7`
      ...
      `ui/main_window.py` (кредитный диалог). ~~mypy в CI не включён: 175 ошибок~~ —
      **закрыто 2026-09-25**: полный свод ruff (712 → 0) и job `mypy` (179 → 0),
      см. CHANGELOG «CI: полный ruff + mypy».
