...
SHARED_SRC="src/rng.cpp src/resources.cpp src/data.cpp src/earth.cpp src/game.cpp src/rewards.cpp src/env.cpp src/lot_finder.cpp src/action_mask.cpp src/observation.cpp"
