...
CHECKS="curriculum_check reward_regressions road_direction_check water_mask_check p0_p1_check gui_watch_check reward_v4_longrun stage1_gate_check mask_reason_check"
