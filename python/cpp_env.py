...
class Normalizer:
    ...
    def set_update(self, enable: bool) -> None:
    ...
    def normalize(self, obs: np.ndarray) -> np.ndarray:
        ...
        obs_flat: np.ndarray = np.asarray(obs, dtype=np.float32).flatten().copy()
...
class CppColonyEnv(gym.Env):
    ...
    def set_step_log(self, path: str) -> None:
    ...
    @property
    def unwrapped(self) -> "CppColonyEnv":
        return self
