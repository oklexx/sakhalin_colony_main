...
PRESETS: dict[str, Preset] = {
    ...
    "full": {
        ...
        "summary": "Полная игра: все 32 здания, все действия. Кнопка «Дообучить» включит этот режим и снизит скорость обучения.",
        "learning_rate": 3e-5,
        "eval_min_days": 730.0,
        "eval_min_bases": 5,
        "detail": (
            "Все здания и действия открыты; бонусы всех ресурсов равны.\n"
            "Кнопка «Дообучить» на вкладке «Модели» автоматически применяет этот режим,\n"
            "ставит скорость обучения 0.00003 и загружает веса выбранной модели.\n"
            "Порог проверки: не менее 730 дней и 5 зданий."
        ),
        "buildings": [],   # пусто = все
        "resources": [],   # пусто = все
